  ...
  return (
    <div className='w-[90vw] md:w-[35vw] p-7 flex flex-col justify-center'>
      ...
      <form className='flex flex-col gap-3' onSubmit={handleCreateSession}>
        ...
        <Input value={formData.description} onChange={({target})=>handleChange("description",target.value)} label={"Description"} placeholder={"(Any specific goals or notes for this session"} type={"text"}/>
